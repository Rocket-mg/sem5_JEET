...
public class Wypisywanie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String orderby = request.getParameter("issorted");
        int orderbyimie;
        System.out.println("zxc");
        if(orderby == null){
            orderbyimie = 0;
        ...
        //orderbyimie = orderby.equals("true");
        
        try (PrintWriter out = response.getWriter()) {
            System.out.print("zxc");
            //System.out.print(orderbyimie);
           ...
           // out.println(getDataFromDb());
            out.println(new PracownicyQuery().getPracownicyLista(orderbyimie));
