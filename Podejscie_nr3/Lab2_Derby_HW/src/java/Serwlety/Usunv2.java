 ...
 * @author student
 */
@WebServlet(name = "Usunv2", urlPatterns = {"/Usunv2"})
public class Usunv2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(IDp != null) {
            int wyn = new PicturesQuery().usunImage(IDp);
            if(wyn == 1)
            {
                kom_usunieto = "Usunieto obraz o ID "+IDp;
            }
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>" + kom_usunieto+"<br />Lista obrazow<br />"); 
